...
public class BloomEffect {
    ...
    public static final float STRENGTH = 1.5F;
    public static final float BASE_BRIGHTNESS = 0.1F;
    public static final float HIGH_BRIGHTNESS_THRESHOLD = 0.5F;
    public static final float LOW_BRIGHTNESS_THRESHOLD = 0.5F;
    public static final float STEP = 1F;

    public static float strength = 1.5F;
    public static float baseBrightness = 0.1F;
    public static float highBrightnessThreshold = 0.5F;
    public static float lowBrightnessThreshold = 0.5F;
    ...
    private static void cleanUP(int lastWidth, int lastHeight) {
        if (downSampleFBO == null || downSampleFBO.length != nMips) {
            ...
            downSampleFBO = new Framebuffer[nMips];
            upSampleFBO = new Framebuffer[nMips];
