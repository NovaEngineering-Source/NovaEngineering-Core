...
public class BloomEffectUtil {
    ...
    public static BlockRenderLayer getEffectiveBloomLayer(BlockRenderLayer fallback) {
        return ShaderManager.isOptifineShaderPackLoaded() ? fallback : bloom;
    }
    ...
    public static BlockRenderLayer getEffectiveBloomLayer(boolean isBloomActive, BlockRenderLayer fallback) {
        return ShaderManager.isOptifineShaderPackLoaded() || !isBloomActive ? fallback : bloom;
    }
...
//    }
    ...
    public static BloomRenderTicket registerBloomRender(@Nullable IRenderSetup setup,
        ...
        if (ShaderManager.isOptifineShaderPackLoaded()) return null;
...
//        BloomEffect.strength = BloomEffect.STRENGTH;
//        BloomEffect.baseBrightness = BloomEffect.BASE_BRIGHTNESS;
//        BloomEffect.highBrightnessThreshold = BloomEffect.HIGH_BRIGHTNESS_THRESHOLD;
//        BloomEffect.lowBrightnessThreshold = BloomEffect.LOW_BRIGHTNESS_THRESHOLD;
//        BloomEffect.step = BloomEffect.STEP;
        // TODO BloomStyle.
