...
import github.kasuminova.novaeng.common.hypernet.computer.module.base.ModuleCPUBase;
...
public class SlotCPUItemHandler extends SlotConditionItemHandler {
    ...
    public SlotCPUItemHandler(final int displayID, final int index, final TileItemHandler inventoryIn) {
