...
import github.kasuminova.novaeng.common.block.efabricator.BlockEFabricatorMEChannel;
...
public class EFabricatorMEChannel extends EFabricatorPart implements ICraftingProvider, IActionHost, IGridProxyable {
    ...
    public void provideCrafting(final ICraftingProviderHelper craftingTracker) {
        ...
        List<EFabricatorPatternBus> patternBuses = controller.getFabricatorPatternBuses();
        patternBuses.stream()
    ...
    public boolean pushPattern(final ICraftingPatternDetails pattern, final InventoryCrafting table) {
        ...
        return fabricatorController.offerWork(new EFabricatorWorker.CraftWork(remaining, output));
    }
    ...
    public boolean insertPattern(final ItemStack patternStack) {
        ...
        if (fabricatorController != null) {
            return fabricatorController.insertPattern(patternStack);
        }
        return false;
    }
    ...
    public boolean isBusy() {
        if (fabricatorController != null) {
            return fabricatorController.isQueueFull();
        }
        return false;
    }
    ...
    public void onAssembled() {
        ...
        ModularMachinery.EXECUTE_MANAGER.addSyncTask(() -> {
            proxy.onReady();
            fabricatorController.recalculateEnergyUsage();
        });
    }
