...
public class StartStopPanel extends Column {
    ...
    public StartStopPanel(final GuiSingularityCore coreGUI) {
        ...
        addWidgets(
                ...
                new Row().addWidgets(
                        new Button4State()
                                .setMouseDownTextureXY(1, 32)
                                .setHoveredTextureXY(1, 16)
                                .setTextureXY(1, 0)
                                .setUnavailableTextureXY(1, 48)
                                .setTextureLocation(BUTTON_TEX_RES)
                                .setTooltipFunction(button -> Collections.singletonList("§c单击停止工作进程。"))
                                .setWidthHeight(31, 15)
                                .setMarginRight(3),
                        new Button4State()
                                .setMouseDownTextureXY(33, 32)
                                .setHoveredTextureXY(33, 16)
                                .setTextureXY(33, 0)
                                .setUnavailableTextureXY(33, 48)
                                .setTextureLocation(BUTTON_TEX_RES)
